<?php
    ...
    <div id=\"downloadContent\">
        <ul id=\"centeredUL\">
            <li><p>Basen är huvudprogrammet, du måste ha denna.</p></li>
            <li><p>Ett tema som ger menyn ett snyggt utseénde.</p></li>
            <li><p>En effekt är en animation som är valfritt.</p></li>
        </ul>
